                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(success == 1){
                                ...
                                userList = gson.fromJson(jsonArray1.toString(), listType);

                                Toast.makeText(getApplicationContext(),"UserList: "+userList.size(),Toast.LENGTH_LONG).show();

                                adapter = new UsersAdapter(AllUsersActivity.this,R.layout.list_item,userList);
